...
const CERTIFICATIONS: Certification[] = [
    {
        title: "Python Course - Data processing intermediate level",
        description: "",
        ...
        skills: ["Advanced Python programming", "Pandas", "DataFrames", "Strings"],
    },
    {
        title: "Python Course - Programming tools for data processing",
        description: "",
        ...
        skills: ["Python programming", "Data processing", "Basic programming concepts and flow control", "Files and data handling"],
    },
    {
        ...
        skills: ["Azure Bot Services", "Azure Machine Learning", "AzureCognitive Services"],
    }
]
