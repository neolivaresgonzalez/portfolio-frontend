...
export function HeroSection() {
    return (
        <div id="hero-section" className="flex flex-1 flex-col h-full m-0 p-0 min-h-screen justify-between py-10">
            <div id="hero-section-content" className="flex flex-col md:flex-row items-center justify-center gap-12 px-4">
